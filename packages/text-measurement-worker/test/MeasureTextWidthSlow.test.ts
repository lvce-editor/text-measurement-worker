...
test.skip('measureTextWidthSlow returns width for simple text', () => {
  const width = MeasureTextWidthSlow.measureTextWidthSlow('hello', 400, 16, 'Arial', 0, false, 10)
  expect(width).toBeGreaterThan(0)
  expect(typeof width).toBe('number')
})

test.skip('measureTextWidthSlow returns different width for different font sizes', () => {
...
test.skip('measureTextWidthSlow returns different width for different letter spacing', () => {
...
test.skip('measureTextWidthSlow returns different width for different fonts', () => {
...
test.skip('measureTextWidthSlow returns different width for different font weights', () => {
...
test.skip('measureTextWidthSlow returns width for empty string', () => {
  const width = MeasureTextWidthSlow.measureTextWidthSlow('', 400, 16, 'Arial', 0, false, 10)
  expect(width).toBe(0)
})

test.skip('measureTextWidthSlow returns width for longer text', () => {
...
test.skip('measureTextWidthSlow throws error for invalid text type', () => {
  expect(() => {
    // @ts-expect-error
...
test.skip('measureTextWidthSlow throws error for invalid letterSpacing type', () => {
  expect(() => {
    // @ts-expect-error
